...
class RegisterShopScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocListener<RegisterShopBloc, RegisterShopState>(
                        ...
                        children: [
                          Padding(
                            ...
                            child: ImageWithText(
                              ...
                              text: "حذف".tr(),
                              onPressed: () =>
                                  context.read<RegisterShopBloc>().removeFile(),
                            ...
                            children: [
                              ...
                              Card(
                                ...
                                child: Padding(
                                  ...
                                  child: Text("${state.shareCount.length}"),
                                ),
                              ),
                            ],
                          ),
                            ...
                            children: [
                              ...
                              Card(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: 30.0, vertical: 10),
                                  child: Text("${state.viewersCount.length}"),
                                ),
                              ),
                            ],
                          ),
                            ...
                            children: [
                              ...
                              Card(
                                ...
                                child: Padding(
                                  padding: const EdgeInsets.symmetric(
                                      horizontal: 30.0, vertical: 10),
                                  child: Text("${state.followersCount.length}"),
                                ),
                              ),
                            ],
                          )
