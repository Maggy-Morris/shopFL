...
class OffersScreenUser extends StatefulWidget {
  static const String routeName = '/offers-screen-user';

  const OffersScreenUser({super.key});
  @override
  // ignore: library_private_types_in_public_api
  _OffersScreenUserState createState() => _OffersScreenUserState();
}

class _OffersScreenUserState extends State<OffersScreenUser> {
